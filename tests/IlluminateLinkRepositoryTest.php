...
class IlluminateLinkRepositoryTest extends PHPUnit_Framework_TestCase {
	...
	{
		$linkRepository = m::mock('Cartalyst\SentinelSocial\Links\IlluminateLinkRepository[createModel]');
	...
	{
		$provider = new IlluminateLinkRepository;
		$model = $provider->createModel();
		$this->assertInstanceOf('Cartalyst\SentinelSocial\Links\EloquentLink', $model);
	}
